...
int main() {
    ...
    double z0 = -24.6568, w0 = 0.0586, theta0 = 0.0054, q0 = 6.7975e-04;
    double psi0 = 1.7896e-05, r0 = 1.5383e-05;
    ...
    double zf = -28.4504, thetaf = 0.0;
    double psif = -2.1404e-04;

    // NEW: previous controls (used in get_bounds_info: x_lower[...]=x_upper[...]=*_prev)
    double dv_prev = 0.2883;
    double ds_prev = 2.5219;
    double dm_prev = 17.8343;
    double dh_prev = 0.0065;
